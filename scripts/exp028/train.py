...
EXPERIMENT_NAME = "exp028_glucose_lipid_composite"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp028"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp027" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 28
FEATURE_FAMILY = "Glucose-lipid-metabolic syndrome composite features"
