...
EXPERIMENT_NAME = "exp026_categorical_encoding"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp026"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp025" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 26
FEATURE_FAMILY = "Categorical encoding strategy sweep"
