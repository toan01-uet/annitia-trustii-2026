...
EXPERIMENT_NAME = "exp030_cardiac_stress_interact"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp030"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp029" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 30
FEATURE_FAMILY = "Cardiac stress interaction family"
