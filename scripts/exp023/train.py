...
EXPERIMENT_NAME = "exp023_robust_scaling"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp023"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp022" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 23
FEATURE_FAMILY = "Robust scaling and outlier clipping variants"
