...
EXPERIMENT_NAME = "exp003_visit_minmax_mean_std"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp003"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp002" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 3
FEATURE_FAMILY = "Wide-visit min/max/mean/std summary features"
