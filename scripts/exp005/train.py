...
EXPERIMENT_NAME = "exp005_visit_recency_persistence"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp005"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp004" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 5
FEATURE_FAMILY = "Wide-visit recency and persistence features"
