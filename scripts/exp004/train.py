...
EXPERIMENT_NAME = "exp004_visit_slope_trend"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp004"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp003" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 4
FEATURE_FAMILY = "Wide-visit slope and trend proxy features"
