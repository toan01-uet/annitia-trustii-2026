...
EXPERIMENT_NAME = "exp008_log_winsorized"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp008"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp007" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 8
FEATURE_FAMILY = "Log-transform and winsorized biomarker features"
