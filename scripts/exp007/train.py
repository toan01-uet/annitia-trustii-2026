...
EXPERIMENT_NAME = "exp007_missingness_flags"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp007"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp006" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 7
FEATURE_FAMILY = "Missingness flags and panel coverage features"
