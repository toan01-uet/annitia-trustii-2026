...
EXPERIMENT_NAME = "exp017_higher_risk_interaction"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp017"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp016" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 17
FEATURE_FAMILY = "Higher-risk interaction gates and capped interactions"
