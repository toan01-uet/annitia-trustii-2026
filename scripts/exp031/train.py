...
EXPERIMENT_NAME = "exp031_renal_hepatic_interact"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp031"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp030" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 31
FEATURE_FAMILY = "Renal-hepatic interaction family"
