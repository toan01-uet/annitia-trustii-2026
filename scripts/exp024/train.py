...
EXPERIMENT_NAME = "exp024_hepatic_specific"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp024"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp023" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 24
FEATURE_FAMILY = "Endpoint-specific hepatic-event feature block"
