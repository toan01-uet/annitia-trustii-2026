...
EXPERIMENT_NAME = "exp009_clinical_burden"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp009"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp008" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 9
FEATURE_FAMILY = "Clinical burden and comorbidity count features"
