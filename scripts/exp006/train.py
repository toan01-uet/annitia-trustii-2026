...
EXPERIMENT_NAME = "exp006_visit_missingness_trajectory"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp006"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp005" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 6
FEATURE_FAMILY = "Visit-level missingness trajectory features"
