...
EXPERIMENT_NAME = "exp020_group_relative_sex"
EXPERIMENT_DIR = PROJECT_ROOT / "scripts" / "exp020"
OUTPUT_DIR = EXPERIMENT_DIR / "outputs"
BASELINE_SUMMARY_PATH = PROJECT_ROOT / "scripts" / "exp019" / "outputs" / "validation_summary.json"
EXPERIMENT_NUMBER = 20
FEATURE_FAMILY = "Group-relative normalization by sex"
